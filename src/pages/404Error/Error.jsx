...
const Error = () => {
  return (
    <>
      <div className="bg-gray-100 pt-[10%] h-screen justify-center items-center">
        ...
        <center className="mt-6">
          <Link to={"/Ragistration"} className="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">
            Go back
          </Link>
        </center>
      </div>
