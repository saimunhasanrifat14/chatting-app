      ...
      <div className="w-full flex flex-col items-center justify-center">
        <div className="relative group w-[100px] h-[100px] rounded-full overflow-hidden">
          ...
          <div
            ...
            className="cursor-pointer absolute rounded-full inset-0 bg-black opacity-0 group-hover:opacity-60 transition-opacity duration-300"
          ></div>
          <span onClick={handleUploadProfile} className="cursor-pointer p-8 rounded-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-3xl hidden group-hover:block">
            <FiUpload />
          </span>
        </div>
